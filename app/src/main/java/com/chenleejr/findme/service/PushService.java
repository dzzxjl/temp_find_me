...
public class PushService extends Service
{
	...
	private static final String		MQTT_HOST = "112.74.92.230";
	...
	public static String			MQTT_CLIENT_ID = "FindMe";
	...
	public static void actionStart(Context ctx) {
        ...
        //Editor e = getSharedPreferences(TAG, MODE_PRIVATE).edit();
	...
	private void showNotification(String message, Context context, String content, String ticker) {
		...
		mNotifMan.notify(NOTIF_CONNECTED, noti);
	}
	...
	private class MQTTConnection implements MqttSimpleCallback {
		...
		public void publishArrived(String topicName, byte[] payload, int qos, boolean retained) {
			...
			showNotification(s, getApplicationContext(), "You have message", "Message");
			log("Got message: " + s);
		}   
